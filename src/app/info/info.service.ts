...
export class InfoService {
  content: Content[] = [
  {
    ...
    tool: [ToolType.Angular, ToolType.Axure, ToolType['C#']],
    content:
  ...
  },
  {
    ...
    role: [RoleType.SA],
    tool: [ToolType.MSSQL, ToolType['站台/VM'], ToolType.Azure],
    content:
  ...
  },
  {
    ...
    project: ProjectType.APP專案,
    role: [RoleType.PM, RoleType.軟體開發],
    tool: [ToolType['C#'], ToolType.MSSQL, ToolType.MSSQL, ToolType.Axure],
    content:
  ...
  },
  {
    ...
    project: ProjectType['CI/CD'],
    role: [RoleType.PM, RoleType.SA, RoleType.軟體開發],
    tool: [ToolType['C#'], ToolType.Angular, ToolType.Axure],
    content:
  ...
  },
  {
    ...
    project: ProjectType['CI/CD'],
    role: [RoleType.PM, RoleType.SA, RoleType.軟體開發],
    tool: [ToolType['C#'], ToolType.Angular, ToolType.Axure, ToolType['stored procedure']],
  ...
  },
  {
    ...
    tool: [ToolType['C#'], ToolType.Angular, ToolType.Jenkins],
    content:
  ...
  },
  {
    ...
    tool: [ToolType.MSSQL, ToolType['stored procedure'], ToolType.PowerBI],
